...
# description: "Every taggable AWS resource must carry the four required tags via provider default_tags or explicit tags."
# custom:
#   control_id: CM-6
#   framework: nist-800-53
#   severity: medium
#   remediation: "Add the four required tags or use provider default_tags { tags = { Project, Environment, ManagedBy, ComplianceScope } }."
